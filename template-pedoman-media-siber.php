				...
				<div class="paijo-prose prose-lg dark:prose-invert max-w-none text-paijo-ink">
					...
					?>
						...
						<div style="margin-top: 2rem; background: #f5f5f5; border-radius: 1rem; padding: 1.5rem; text-align: center;">
							...
							<a href="mailto:<?php echo esc_attr( $admin_email ); ?>" class="inline-flex items-center justify-center bg-[#f1818f] text-white font-bold py-3 px-6 sm:px-8 rounded-full transition-colors w-full sm:w-auto hover:bg-[#d96a78] max-w-full no-underline">
