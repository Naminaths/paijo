<?php
/**
 * Tag archive template (Kumparan Topic Style - Centered List, No Sidebar).
 *
 * @package Paijo
 */
				...
				<div>
					...
					<div class="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-paijo-muted font-bold uppercase tracking-wider">
						...
						<?php if ( ! empty( $current_tag->description ) ) : ?>
							<span class="text-neutral-300" aria-hidden="true">•</span>
							<span class="normal-case font-medium text-paijo-muted max-w-md truncate inline-block"><?php echo esc_html( $current_tag->description ); ?></span>
						<?php endif; ?>
					</div>
				</div>
			</div>
